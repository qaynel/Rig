# Tier 2 Basic — Consolidated Design (ARCHIVED)

> **ARCHIVED 2026-07-24 (GA-9g).** Basic / mid / Advanced install packages are
> deprecated. Active delivery is mandatory baseline + à-la-carte catalogue —
> see [`../../../README.md`](../../../README.md)
> and [`../../../current/spec/business-spec.md`](../../../current/spec/business-spec.md).
> This file is retained only as historical MCP-configurator design (host matrix,
> secret chain). The legacy CLI path remains for compatibility; this is not a
> current install tier.

**Historical single source of truth for the Tier 2 Basic MCP configurator.** Consolidated 2026-07-18 from the four working docs
...
- Sibling archived packaging doc: `../tier-2-design.md`
...
| Not in this MCP path | Where it lives now | Why |
|---|---|---|
| Agents, multi-step loops, dispatched work | Tier 3 / out of catalogue scope | Config + creds only here. |
| Repo-scoped memory / learning store | Tier 3 (out of scope) | State beyond creds; Cap A / memory deferred. |
| A Rig LLM runtime / model key | Non-goal (B2 rejected; B1 locked) | #11: the agent is the generator; Rig emits config. |
