# Tier 2 — Design (ARCHIVED — superseded by à-la-carte catalogue)

> **ARCHIVED 2026-07-24 (GA-9g).** This document described the obsolete Basic vs
> Advanced package split (and open G11a). Do not use it as current intent.
> Active delivery: [`../../README.md`](../../README.md).

Exported 2026-07-16 from the grill session. Companion decisions log:
`../grilling/grill-decisions.md`. Source of truth for the overall product:
`../foundational/rig-foundational-design.md`. Tier 1 sibling:
`../tier-1-design-docs/tier-1-mvp-design.md`.

**Status:** **ARCHIVED.** The Basic/Advanced split (G11) and open G11a fork below are
**historical**. B1 is locked (GA-2); packaging dissolved into the catalogue (GA-9g).
Historical MCP design: [`basic/basic-design.md`](basic/basic-design.md).
