...
**Resolution (historical):** **Both, as sub-levels** (maps onto the à-la-carte spectrum #2):
...
**⚠ OPEN (G11a) — SUPERSEDED 2026-07-24:** host-brain (B1) vs Rig-brain (B2) was locked **B1** in
Advanced grilling (GA-2). The Basic / mid / Advanced **package taxonomy itself** was later
**deprecated (GA-9g)** — there is no installable Basic/mid/Advanced tier. Active delivery is
**mandatory agent-tech-safety baseline + à-la-carte catalogue**
(`family → group → service → grade`). Memory store / Cap A runtime remain **Tier 3 / out of
scope**. See `../../current/spec/business-spec.md` and
