...
> Deferred — genuinely need product-manager / intent-owner input. Each has a
> solution doc with a recommendation and the exact decision or owner action.
...
**Complete cards moved here.** See the linked solution doc for what changed.
...
The three below landed with `npm test` green (root 380/380, pi-extension 15/15) on 2026-08-24.
