...
- [ ] **RIG-148 — Default install lands unignored: 209 files / 8.3 MB with no .gitignore**
	**Status:** OPEN (2026-08-30) — GitHub: not yet filed — found during Path A install-bug investigation · [Solution](tickets/RIG-148.md)
...
- [ ] **RIG-149 — Vendored `rig` switchboard installs as `rig-rig`, breaking routing.md's own fallback instruction**
	**Status:** OPEN (2026-08-30) — GitHub: not yet filed — found during Path A install-bug investigation · [Solution](tickets/RIG-149.md)
...
- [ ] **RIG-150 — `.rig/rules/rig.md` points at a path the common install never writes**
	**Status:** OPEN (2026-08-30) — GitHub: not yet filed — found during Path A install-bug investigation · [Solution](tickets/RIG-150.md)
...
- [ ] **RIG-151 — routing.md's full-cadence branch asserts a wiki/status.md convention the target repo doesn't have**
	**Status:** OPEN (2026-08-30) — GitHub: not yet filed — found during Path A install-bug investigation · [Solution](tickets/RIG-151.md)
...
- [ ] **RIG-152 — "In this source checkout" conditionals in routing.md are always-false once installed**
	**Status:** OPEN (2026-08-30) — GitHub: not yet filed — found during Path A install-bug investigation · [Solution](tickets/RIG-152.md)
...
- [ ] **RIG-153 — No frozen instrument exists to measure adaptation quality**
	**Status:** OPEN (2026-08-30) — GitHub: not yet filed — found during Path A install-bug investigation · [Solution](tickets/RIG-153.md)
...
- [ ] **RIG-124.2 — `(RIG-124)` test-title citation convention leaks into installed payload text**
	**Status:** OPEN (2026-08-30) — GitHub: not yet filed — found during Path A install-bug investigation, unrelated to RIG-124.1 · [Solution](tickets/RIG-124.md)
