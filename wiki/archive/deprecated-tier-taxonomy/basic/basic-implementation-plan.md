...
- **Spec (single source of truth):** `project-dev-docs/archive/deprecated-tier-taxonomy/basic/basic-design.md` (also attached as `.context/attachments/5FWzDU/basic-design.md`).
...
- [ ] **Step 3:** Record the two unverified assumptions as an open note in `project-dev-docs/archive/deprecated-tier-taxonomy/basic/` (not a blocker; carried as a caveat per §11).
- [ ] **Step 4: Commit**
