...
# the older V0 prose can set `rig-config set explain_level terse`.
#
...
PROMPTED_FLAG="$RIG_HOME/.writing-style-prompted"
PENDING_FLAG="$RIG_HOME/.writing-style-prompt-pending"
...
EXPLAIN_LEVEL_SET="$("${HOME}/.claude/skills/rig/bin/rig-config" get explain_level 2>/dev/null || true)"
