...
This phase generates visual previews of the proposed design system. Two paths depending on whether the rig designer is available.
...
_DESIGN_DIR="$HOME/.rig/projects/$SLUG/designs/design-system-$(date +%Y%m%d)"
mkdir -p "$_DESIGN_DIR"
