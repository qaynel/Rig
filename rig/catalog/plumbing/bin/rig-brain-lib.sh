# rig-brain-lib.sh — shared helpers for setup-brain bin scripts.
#
# This file is NOT executable; source it:
#
#   . "$(dirname "$0")/rig-brain-lib.sh"
#
# Provides:
...
# _rig_brain_validate_varname <name> — returns 0 if usable, 2 otherwise.
...
read_secret_to_env() {
  ...
  if ! _rig_brain_validate_varname "$varname"; then
