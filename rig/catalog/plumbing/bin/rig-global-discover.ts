#!/usr/bin/env bun
/**
 * rig-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   rig-global-discover --since 7d [--format json|summary]
 *   rig-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: rig-global-discover --since <window> [--format json|summary]
...
Examples:
  rig-global-discover --since 7d
  rig-global-discover --since 14d --format summary`);
}
