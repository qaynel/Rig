...
window.EXCALIDRAW_ASSET_PATH = "https://rig-render.localhost/excalidraw-assets/";
...
window.__bundleInfo = { name: "rig-diagram-render", deps: __BUNDLE_INFO_DEPS__ };
