...
This rule is always active. It never permits removing trust-boundary validation,
data-loss prevention, security, accessibility, explicit requirements, or the
